...
const ToggleButton = styled(IconButton)(({ theme }) => ({
  ...
  transition: 'left 0.25s ease-in-out, background-color 0.2s ease',
  '&:hover': {
...
const Navigation = () => {
  ...
  return (
    ...
    <>
      ...
      {/* Toggle Button - Always visible, positioned at sidebar edge */}
      {!isBreakpointReached && (
        <Tooltip title='Toggle Sidebar' placement='right'>
          <ToggleButton size='small' onClick={() => toggleVerticalNav()}>
